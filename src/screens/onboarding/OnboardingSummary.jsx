  ...
  return (
    <div style={{ flex: 1, display: 'flex', flexDirection: 'column', background: BG }}>
      ...
      <div style={{ flex: 1, overflowY: 'auto', padding: '20px 24px 0' }}>
        <div style={{ fontFamily: 'Denim Ink', fontWeight: 600, fontSize: 28, color: TEXT, lineHeight: 1.2, marginBottom: 4, letterSpacing: '-0.3px' }}>
          Here's what we found
        </div>
        <div style={{ fontFamily: 'Inter', fontWeight: 500, fontSize: 15, color: TEXT_SUB, marginBottom: 24 }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 10, marginBottom: 14 }}>
          {CARDS.map(({ icon, label, value, sub }) => (
            <div key={label} style={{
              ...
              <div style={{ flex: 1 }}>
                <div style={{ fontFamily: 'Inter', fontWeight: 600, fontSize: 12, color: TEXT_SUB, marginBottom: 2 }}>{label}</div>
                <div style={{ fontFamily: 'Inter', fontWeight: 700, fontSize: 15, color: TEXT }}>{value}</div>
                <div style={{ fontFamily: 'Inter', fontWeight: 500, fontSize: 12, color: TEXT_SUB, marginTop: 1 }}>{sub}</div>
              </div>
            </div>
          ))}
        </div>
        ...
        <div style={{
          ...
          <div style={{ display: 'flex', alignItems: 'flex-start', gap: 10 }}>
            ...
            <div>
              <div style={{ fontFamily: 'Inter', fontWeight: 700, fontSize: 15, color: TEAL, marginBottom: 3 }}>
                89% felt better in 3 weeks
              </div>
              <div style={{ fontFamily: 'Inter', fontWeight: 500, fontSize: 13, color: TEXT_SUB, lineHeight: 1.5 }}>
